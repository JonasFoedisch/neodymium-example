...
public class BrowseTest extends AbstractTest
{
    ...
    public void testBrowsing()
    {
        ...
        // Go to product page
        final String productName2 = categoryPage.getProductNameByPosition(1, 2);
        productPage = categoryPage.clickProductByPosition(1, 2);
        productPage.validate(productName2);

        // Go to category
        final String categoryName3 = productPage.topNav.getSubCategoryNameByPosition(4, 3);
        categoryPage = productPage.topNav.clickSubCategoryByPosition(4, 3);
        categoryPage.validate(categoryName3);

        // Go to product page
        final String productName3 = categoryPage.getProductNameByPosition(1, 6);
        productPage = categoryPage.clickProductByPosition(1, 6);
